    ...
    <style>
        ...
        @media (max-width: 767.98px) {
            .dashboard-sidebar {
                ...
                top: 56px;
                left: 0;
                display: block !important; /* Important pour override Bootstrap */
                z-index: 1050;
            }
...
<body>
    ...
    <div class="dashboard-main-content" id="mainContent">
        <!-- Le contenu principal de chaque page ira ici -->
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (sidebarToggle && dashboardSidebar) {
                ...
                const sidebarLinks = dashboardSidebar.querySelectorAll('.nav-link');
                ...
                // Fermer le sidebar si on redimensionne la fenêtre vers desktop
