...
$tables = [];
try {
    $stmt = $pdo->query("SELECT id, table_name, capacity FROM tables WHERE is_available = 1 ORDER BY table_name");
                            ...
                            <select class="form-control" name="table_id" id="table_id">
                                ...
                                <?php foreach ($tables as $table): ?>
                                    <option value="<?= $table['id'] ?>">
                                        <?= htmlspecialchars($table['table_name']) ?> (<?= $table['capacity'] ?> pers.)
                                    </option>
                                <?php endforeach; ?>
                            </select>
                        </div>
...
<script>
    ...
    function openCreate() {
        ...
        document.getElementById('table_id').value = ''; // Réinitialiser le select
    ...
    function openEdit(row) {
        ...
        // CORRECTION : Utiliser table_id au lieu de table_name
        document.getElementById('table_id').value = row.table_id || '';
    }
