...
<div class="container py-4">
    <h1 class="h4 mb-3"><i class="fas fa-leaf me-2 text-success"></i>Menu Entrée</h1>
    <form class="row g-2 mb-3" method="GET">
        <div class="col-md-8"><input class="form-control" name="q" value="<?= htmlspecialchars($q) ?>" placeholder="Rechercher une entrée..."></div>
        <div class="col-md-4"><button class="btn btn-primary w-100" type="submit"><i class="fas fa-search me-1"></i>Rechercher</button></div>
    </form>

    <div class="row g-3">
        <?php if (empty($rows)): ?>
            <div class="col-12 text-center text-muted py-5">Aucune entrée trouvée</div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="like.php?id=<?= $p['id'] ?>&back=menu_entree.php" class="btn btn-sm <?= $liked ? 'btn-success' : 'btn-outline-success' ?>"><i class="fas fa-thumbs-up"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
