...
<div class="container py-4">
    <h1 class="h4 mb-3"><i class="fas fa-ice-cream me-2 text-warning"></i>Desserts</h1>
    <form class="row g-2 mb-3" method="GET">
        <div class="col-md-8"><input class="form-control" name="q" value="<?= htmlspecialchars($q) ?>" placeholder="Rechercher un dessert..."></div>
        <div class="col-md-4"><button class="btn btn-primary w-100" type="submit"><i class="fas fa-search me-1"></i>Rechercher</button></div>
    </form>

    <div class="row g-3">
        <?php if (empty($rows)): ?>
            <div class="col-12 text-center text-muted py-5">Aucun dessert trouvé</div>
                    ...
                    <div class="card-body d-flex flex-column">
                        ...
                        <div class="mt-auto d-flex justify-content-between align-items-center">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <a href="like.php?id=<?= $p['id'] ?>&back=menu_dessert.php" class="btn btn-sm <?= $liked ? 'btn-success' : 'btn-outline-success' ?>"><i class="fas fa-thumbs-up"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
